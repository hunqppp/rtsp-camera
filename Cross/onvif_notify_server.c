...
#define DEFAULT_CONF_FILE   ONVIF_NOTIFY_SERVER_DEFAULT_CONF_FILE
#define TEMPLATE_DIR        ONVIF_NOTIFY_SERVER_TEMPLATE_DIR
#define DEFAULT_LOG_FILE    ONVIF_NOTIFY_SERVER_DEFAULT_LOG_FILE
#define DEFAULT_PID_FILE    ONVIF_NOTIFY_SERVER_DEFAULT_PID_FILE
#define INOTIFY_DIR         ONVIF_NOTIFY_SERVER_INOTIFY_DIR
