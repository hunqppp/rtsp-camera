...
export CROSS_COMPILE_HOST="--host=arm-linux"
export CC="$HOME/Toolchains/asdk-10.3.1-a7-EL-5.4-u1.0-a32nh-220218/bin/arm-linux-gcc"
export CXX="$HOME/Toolchains/asdk-10.3.1-a7-EL-5.4-u1.0-a32nh-220218/bin/arm-linux-g++"
export STRIP="$HOME/Toolchains/asdk-10.3.1-a7-EL-5.4-u1.0-a32nh-220218/bin/arm-linux-strip"
