...
#define OUR_HLS_SEGMENTATION_DURATION 60 /*seconds*/
#define OUR_HLS_REWIND_DURATION 60 /*seconds: How far back in time a browser can seek*/

////////////////////////////////////////
// User Configurations
////////////////////////////////////////
#define usrProgrameName       "live555HLSProxy"
#define usrStreamUsingTCP     False
#define usrHTTPTServPortNum   0
#define usrRTSPURL            "rtsp://192.168.1.178:8554/unicast"
#define usrHLSPrefix          "UpStream"

UsageEnvironment* env;
char const* programName = usrProgrameName;
char* username = NULL;
char* password = NULL;
Authenticator* ourAuthenticator = NULL;
Boolean streamUsingTCP = usrStreamUsingTCP;
portNumBits tunnelOverHTTPPortNum = usrHTTPTServPortNum;
...
int main(int argc, char** argv) {
  ...
  *env << "\t(LIVE555 Streaming Media version " << LIVEMEDIA_LIBRARY_VERSION_STRING << ")\n";
  ...
  if (createHandlerServerForREGISTERCommand) {
    ...
    char const* rtspURL = usrRTSPURL;
    hlsPrefix = usrHLSPrefix;
